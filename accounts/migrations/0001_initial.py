    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Super Admin'), ('tenant_admin', 'Tenant Admin'), ('operations_manager', 'Operations Manager'), ('driver', 'Driver'), ('finance_manager', 'Finance Manager'), ('customer', 'Customer')], default='customer', max_length=30)),
